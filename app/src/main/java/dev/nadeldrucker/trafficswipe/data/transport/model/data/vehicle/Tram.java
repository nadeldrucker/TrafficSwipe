package dev.nadeldrucker.trafficswipe.data.transport.model.data.vehicle;
...
public class Tram extends Vehicle {
     ...
     */
    public Tram(RequestQueue queue, @NonNull String lineId, @NonNull String direction, @Nullable String entityId, @NonNull Map<Station, DepartureTime> targetDestination) {
